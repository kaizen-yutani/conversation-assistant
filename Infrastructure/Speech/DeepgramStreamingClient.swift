...
class DeepgramStreamingClient: NSObject {
    ...
    func connect(language: String = "en") {
        ...
        components.queryItems = [
            ...
            URLQueryItem(name: "endpointing", value: "500"),  // 500ms silence = end of utterance
        ...
        webSocket?.resume()
        // isConnected is set by URLSessionWebSocketDelegate.didOpenWithProtocol
        // Do NOT set it here — the handshake hasn't completed yet
