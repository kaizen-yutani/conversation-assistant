...
class GroqSpeechClient {
    ...
    func transcribe(audioData: Data, filename: String = "audio.m4a") async throws -> (text: String, latencyMs: Double) {
        ...
        // General vocabulary hints for speech recognition
        let vocabulary = "API, REST, GraphQL, SQL, NoSQL, Docker, Kubernetes, CI/CD, Git, AWS, Jira, Confluence, Playwright, Testmo, sprint, backlog, pull request, deployment"
        body.append("--\(boundary)\r\n".data(using: .utf8)!)
