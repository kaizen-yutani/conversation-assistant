...
enum AnalysisMode {
    ...
    var prompt: String {
        let role = AppSettings.shared.userRole
        ...
        return """
        You are a smart assistant helping a \(role.displayName). Analyze the screenshot and respond appropriately based on what you see.
